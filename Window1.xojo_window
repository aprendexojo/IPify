	...
	#tag Method, Flags = &h0
		Sub IPChanged(IPChangeStatus as Dictionary)
		  ...
		  If IPChangeStatus.Value(IPify.kChangedIP) = True Then
		    ...
		    MessageBox "You are using a new Public or External IP: " + IPChangeStatus.Value(IPify.kCurrentIP)
		    
		  Else
		    
		    MessageBox "Still Using the same old IP: " + IPChangeStatus.Value(IPify.kCurrentIP)
...
#tag Events PBCurrentIP
	#tag Event
		Sub Action()
		  MessageBox "My IP Address is: " + IPify.currentIP
		End Sub
	#tag EndEvent
#tag EndEvents
	...
	#tag Event
		Sub Action()
		  ...
		  If d.value(IPify.kChangedIP) Then
		    ...
		    MessageBox "The IP Address changed to: " + d.value(IPify.currentIP)
		    
		  Else
		    
		    MessageBox "Your are using the same public IP Address: " + d.Value(IPify.kCurrentIP)
